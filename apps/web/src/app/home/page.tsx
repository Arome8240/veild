...
import {
  ...
  Bell, ChevronRight, ExternalLink, Loader2, Eye,
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-background text-white pb-24 flex flex-col items-center justify-center px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-sm">
          ...
          <h1 className="font-bold text-xl mb-2">Connect your wallet</h1>
          <p className="text-zinc-500 text-sm mb-8 leading-relaxed">
            Connect your wallet or open in MiniPay to access your creator dashboard.
          </p>
